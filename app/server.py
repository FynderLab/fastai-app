...
model_file_url = 'https://github.com/FynderLab/DeepLearning/blob/master/Fine-Grained-Clothing-Classification/data/cloth_categories/models/stage-1_sz-150.pth?raw=true'
